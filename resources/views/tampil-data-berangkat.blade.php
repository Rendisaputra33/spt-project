                                    ...
                                    <div class="col-6">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control float-right" id="date-range"
                                                            name="date" value="<?= date('Y-m-d') ?> / <?= date('Y-m-d') ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-6">
                                        ...
                                        @else
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ $item->harga }}</td>
                                                            <td>
                                                                <button type="button" class="btn btn-warning text-bold" data-toggle="modal" data-target="#exampleModal" data-id="{{ $item->id_keberangkatan }}">
