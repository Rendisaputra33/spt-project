                        ...
                        <div class="card-header">
                            <form action="/transaksi/berangkat/cetak" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <button type="submit" class="btn btn-primary float-right text-bold"><i
                                ...
                                <table id="tb" class="table table-bordered table-striped ">
                                    ...
                                    <tbody id='list-data'>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $item->tanggal_pulang === null ? 'belum pulang' :
                                                formatTanggal($item->tanggal_pulang) }}</td>
                                            <td>{{ $item->tipe }}</td>
                                            ...
                                            <td>{{ formatRupiah($item->harga * ($item->berat_pulang - $item->refaksi))
                                                }}</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
